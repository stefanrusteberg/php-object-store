...
<head>
  ...
  <title>Welcome to OpenShift with Object Store</title>
...
<section class='container'>
          <hgroup>
            <h1>OpenShift With Object Storage</h1>
          </hgroup>
...
?>
<br>
<p> Upload a file to our service</p>
...
foreach ($bucket_contents as $file){
    ...
    $fname = $file['name'];
    $furl = "http://" . $bucketname . ".hcp-mchba.hca.siemens.de/" . $fname;
